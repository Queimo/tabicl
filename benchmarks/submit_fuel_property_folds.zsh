...
BENCHMARK_SCRIPT="benchmarks/fuel_property_prediction_benchmark.py"
OUTPUT_DIR="benchmarks/results/fuels"
FORWARD_ARGS=()
...
echo "After jobs finish, aggregate partial outputs with:"
echo "python -u benchmarks/aggregate_fuel_benchmark_results.py --results-dir $OUTPUT_DIR --n-folds $N_FOLDS"
